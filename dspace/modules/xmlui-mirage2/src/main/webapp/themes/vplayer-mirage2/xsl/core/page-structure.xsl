...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template name="addJavascript">
        ...
        <xsl:call-template name="addUniteGallery" />
        
        <xsl:call-template name="addJavascript-google-analytics" />
    </xsl:template>
    
    <xsl:template name="addUniteGallery">
		
		<!-- Include Unite Gallery core files -->
		<script type='text/javascript'>
			<xsl:attribute name="src">
				<xsl:value-of select="$theme-path"/>
				<xsl:text>scripts/unitegallery/js/unitegallery.min.js</xsl:text>
			</xsl:attribute>&#160;
		</script>
		<link rel='stylesheet' type='text/css' >
			<xsl:attribute name="href">
				<xsl:value-of select="$theme-path"/>
				<xsl:text>scripts/unitegallery/css/unite-gallery.css</xsl:text>
			</xsl:attribute>&#160;
		</link>
		...
		<script type='text/javascript'>
			<xsl:attribute name="src">
				<xsl:value-of select="$theme-path"/>
				<xsl:text>scripts/unitegallery/themes/default/ug-theme-default.js</xsl:text>
			</xsl:attribute>&#160;
		</script>
		<link href='' rel='stylesheet' type='text/css' >
			<xsl:attribute name="href">
				<xsl:value-of select="$theme-path"/>
				<xsl:text>scripts/unitegallery/themes/default/ug-theme-default.css</xsl:text>
			</xsl:attribute>&#160;
		</link>
		...
		<script>
			<xsl:attribute name="src">
				<xsl:value-of select="$theme-path"/>
				<xsl:text>scripts/load-unitegallery.js</xsl:text>
			</xsl:attribute>&#160;
		</script>
